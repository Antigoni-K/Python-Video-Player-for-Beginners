...
bgvideo.load(r"https://videos.pexels.com/video-files/10296173/10296173-hd_1280_720_50fps.mp4")
...
vplabel=Label(window, text="             Video Player             ", bg="snow2", font="Corbel 48 bold")
vplabel.place(relx=.5, rely=.37, anchor="c")

descriptionlabel=Label(window, text="A simple, beginner-friendly video player using tkVideoPlayer.", bg="black", fg="white", font="Corbel 11 bold")
descriptionlabel.place(relx=.5, rely=.433, anchor="c")

viewvideobutton=Button(window, text="view videos", font="Corbel 28", bg="snow2", bd=0, width=15, relief="groove", command=selectvideo)
